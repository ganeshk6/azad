...
const Edit = ({ phrasesData }) => {
    ...
    const [wordSection, setWordSections] = useState(phrasesData.SubNotice);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            wordSection.forEach((section, index) => {
                formData.append(`SubNotice[${index}][id]`, section.id);
                formData.append(`SubNotice[${index}][title]`, section.title);
                if (section.image instanceof File) {
                    formData.append(`SubNotice[${index}][image]`, section.image);
                }
            });
            const response = await axios.post(route('notices-edit', getPhrase.id), formData, {
                        ...
                        <div className="col-10 bg-white shadow-md rounded-lg p-6 relative">
                            ...
                            <div>
                                <div className='d-flex justify-between mb-3 align-items-center'>
                                    <label className="form-label h5 fw-bold">Type Notice</label>
                                    <button
                                        type="button"
